        ...
        <ThemeProvider theme={ffTheme}>
            ...
            <Container flex='0.4' justify='center'>
                <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                        <SmallPost imgSrc={Toaster} headerText="Toaster" minW={100} h={150} w={150} onPress={() => {navigation.navigate("donorListing")}}/>
                        <SmallPost imgSrc={Chair} h={150} w={150} onPress={() => {navigation.navigate("donorListing")}}/>
                        <SmallPost imgSrc={Chair} h={150} w={150} onPress={() => {navigation.navigate("donorListing")}}/>
